...
/// @title GoalPotV1 — the original single-contract Goalpot (LEGACY)
/// @notice Superseded by the factory + clone architecture in ../GoalPot.sol.
///         Kept because an instance is deployed on Monad testnet; new pots are
///         created through GoalPotFactory.
